angular.module('instacutz.barberProfile', [])
...
.controller('barberProfileController', [
  ...
  '$http',
  '$window',
  function($scope, $location, Order, Auth, Counter, idTool, $http, $window) {
    ...
    var order = $window.localStorage.getItem('order') || JSON.stringify({
      orders: []
    });
